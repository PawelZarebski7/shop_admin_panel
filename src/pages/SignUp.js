...
import ImageLight from '../assets/img/vegetable-24x7.png';
import ImageDark from '../assets/img/vegetable-24x7.png';
          ...
          <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              >
                ...
                <span className="ml-2">{t('login_fb')}</span>
              </button>
              <button
                disabled
              ...
              >
                ...
                <span className="ml-2">{t('login_google')}</span>
              </button>
              <p className="mt-4">
                <Link
